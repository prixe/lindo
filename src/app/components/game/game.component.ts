...
export class GameComponent implements AfterViewInit {
	...
	constructor(
		...
		this.gamePath = isElectron
			? this.applicationService.gamePath + '/index.html?delayed=true'
	...
	public gameReady(): void {
		if (this.gameLoaded) {
			this.game.window.initDofus(() => {
				...
				if (this.game.credentials) this.connectAccount();
